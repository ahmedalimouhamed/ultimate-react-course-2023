...
export default function App(){
  ...
  function handleSplitBill(value){
    setFriends(friends => friends.map(friend => friend.if === selectedFriend.id ? {...friend, balance:friend.balance + value} : friend))
...
function FormAddFriend({onAddFriend}){
  ...
  return (
    <form className='form-add-friend' onSubmit={handleSublit}>
